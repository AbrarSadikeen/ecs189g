...
if 1:
    ...
    train_loader.dataset_source_folder_path = '/content/ecs189g/data/stage_4_data/text_classification/'
    train_loader.dataset_source_file_name = 'train'
    train_data = train_loader.load()

    test_loader = Dataset_Loader('test', '')
    test_loader.dataset_source_folder_path = '/content/ecs189g/data/stage_4_data/text_classification/'
    ...
    plt.ylabel('value')
    plt.legend()
    plt.savefig('/content/ecs189g/result/stage_4_result/metrics.png')
    plt.show()
    ...
    plt.savefig('/content/ecs189g/result/stage_4_result/loss_curve.png')
    plt.legend()
    plt.show()
    ...
    plt.savefig('/content/ecs189g/result/stage_4_result/acc_curve.png')
    plt.legend()
    plt.show()
