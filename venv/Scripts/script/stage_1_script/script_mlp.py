...
if 1:
    ...
    data_obj.dataset_source_folder_path = 'C:/Users/ataki/Documents/ECS189G_Winter_2025_Source_Code_Template/data/stage_1_data/'
    data_obj.dataset_source_file_name = 'toy_data_file.txt'

    method_obj = Method_MLP('multi-layer perceptron', '')

    result_obj = Result_Saver('saver', '')
    result_obj.result_destination_folder_path = 'C:/Users/ataki/Documents/ECS189G_Winter_2025_Source_Code_Template/result/stage_1_result/MLP_'
